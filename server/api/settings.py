...
SECRET_KEY = 'django-insecure-&_d-3l9gu08edvc5)h&+_er3ae-d=c2@uw=j4i-#ghri9)s(b%'
...
AUTH_USER_MODEL = 'cirricular.User'
...
# Cloudinary settings (set via environment variables)
