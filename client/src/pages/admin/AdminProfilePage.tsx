...
import { User, Mail, Phone, FileText, Shield, Loader2, Pencil, X } from 'lucide-react';
  ...
  return (
    <div className="p-6 lg:p-8 max-w-2xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground mt-1">Manage your administrator account</p>
      </div>

      <div className="bg-card border border-border rounded-2xl p-6 shadow-card mb-4">
          ...
          <div className="relative z-50 mx-4 w-full max-w-lg rounded-2xl border border-border bg-background p-6 shadow-lg">
            <div className="mb-4 flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Update your administrator profile information.</p>
              </div>
            ...
            <div className="space-y-4">
              ...
              {error && <div className="rounded-lg border border-destructive/20 bg-destructive/10 px-4 py-2.5 text-sm text-destructive">{error}</div>}
